enableMulticastValues=("true")
zipfValues=("false")
#seedValues=(4700 7998 4757 8215 4464 5522 2915 9945 7760 2983)
#seedValues=(4757 5522 8215)
seedValues=(8215)
userCounts=(100)
userIterations=(50)
userCacheSizes=(25)
                            ...
                            for dataSize in "${dataSizes[@]}"; do
                                ...
                                for maxBandwidth in "${maxBandwidths[@]}"; do
                                    ...
                                    for maxCoded in "${maxCodedValues[@]}"; do
                                        log_file="code_output${iteration}.log"
